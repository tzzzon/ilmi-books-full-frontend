            ...
            <div className="space-y-12 text-center">
              ...
              <div className="space-y-6 text-lg text-gray-700">
                <p>
                  ...
                  in Urdu Bazar to become one of Pakistan's most trusted sources
                  for educational and Islamic literature.
                </p>

                <p>
                  We're your comprehensive book destination, offering everything
                  from school textbooks to university references, Islamic
                  literature to bestselling novels. Whatever your reading need,
            ...
            <div className="mt-16 grid gap-12 md:grid-cols-2">
              <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                ...
                <p className="text-gray-700">
                  ...
                  student and reader in Pakistan, while preserving and promoting
                  Islamic knowledge.
                </p>
              </div>
